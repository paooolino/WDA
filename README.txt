...
4. cd app
5. composer install
6. point browser >>> done!

You can put vendor/paooolino/WDA/developer_assistant.php file in any directory
(remember to adjust the requires and the loading ini path in the code).
